  ...
  <Layout sidebar>
   <main>
                    <div className="container-fluid">
                        <h2 className="mt-20 page-title">Dashboard</h2>
                ...
                <footer className="py-4 bg-footer mt-auto">
                    <div className="container-fluid">
                        <div className="d-flex align-items-center justify-content-between small">
                            <div className="text-muted-1">© 2020 <b>Dakshin Bharath Handloom</b>. by <a href="http://maroonsb2b.com">Maroons Business Solutions</a></div>
